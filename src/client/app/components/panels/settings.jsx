...
class Settings extends React.Component {
    ...
    if (name == "probes") {
      ...
      this.setState({
        ...
        if ((target.type === 'button') || (target.type === 'select-one')) {
          ...
          if ((name == "sample") || (name == "array") || (name == "annotationType") || (name == "signalType") || (name == "viewMode")) {
            this.renderSettings();
          }
        }
      });
  ...
  renderSettings() {
    ...
    if (probesArray) {
      ...
      axios.post(query_probe_names, { settings })
        .then(
          res => {
            ...
            if (probesCount > 1000) {
              filteredByNameProbesArray = filteredByNameProbesArray.slice(0, 1000);
            }
