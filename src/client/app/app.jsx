...
import Brand       from 'client/app/components/panels/brand.jsx';
import Settings    from 'client/app/components/panels/settings.jsx';
import Viewer      from 'client/app/components/panels/viewer.jsx';
...
class App extends React.Component {
  ...
  updateCurrentProbe(direction) {
    ...
    switch(direction) {
      case 'previous':
        nextProbeIndex = ((previousSettings.probesIndex - 1) >= 0) ? (previousSettings.probesIndex - 1) % previousSettings.probesCount : (previousSettings.probesCount - 1);
        break;
      case 'next':
        nextProbeIndex = (previousSettings.probesIndex + 1) % previousSettings.probesCount;
        break;
      default:
        break;
    }
    ...
    return (
      <div>
        <div className="parent-container">
          ...
          <Panels panelSide="left-side" id="left-side-container" ref="leftSideContainer">
            <Brand brandTitle={this.state.brandTitle} brandSubtitle={this.state.brandSubtitle} />
            <h6 className="description">About</h6>
              <p className="description">The <em>FORGE2 TF</em> application is an adjunct to the <a href="https://forge2.altiusinstitute.org/">FORGE2</a> GWAS analysis tool. This enables the exploration of DNase I tag (chromatin accessibility) signal surrounding GWAS array SNPs and the calculation of significance of overlap with transcription factor binding sites from common TF databases.</p>
            <hr />
        ...
        <div className="hidden-container">
          <img src="assets/img/spinner.svg" className="spinner" />
        </div>
      </div>
    );
  }
